...
export default function BentoBox1() {
  return (
    ...
    >
      <span className="text-white/40 text-sm font-medium mb-3 tracking-widest uppercase">4 Farklı Kategori</span>
      <h3 className="text-white text-3xl font-bold mb-4 tracking-tight leading-tight">
        Sadece Şehrin<br />İyileri.
      </h3>
      <p className="text-white/40 text-sm">Bir tık daha yakında</p>
    </motion.div>
  );
}
